...
The final metadata path must be `%LOCALAPPDATA%\MO2AgentToolkit\runtimes\0.10.6\mo2-runtime\runtime.json`; do not create a nested `mo2-runtime\mo2-runtime` directory.
